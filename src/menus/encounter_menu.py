        ...
        if self.encounter_end_flag:
            ...
            if not self.menu_manager.siren_fleet.afloat:
                ...
                if self.current_encounter+1 < num_encounters:
                    ...
                    if not self.menu_manager.tutorials.next_encounter.completed:
                        self.menu_manager.tutorial = self.menu_manager.tutorials.next_encounter
                else:
                    self.return_to_port_button.active = True

                    if not self.menu_manager.tutorials.return_to_port.completed:
                        self.menu_manager.tutorial = self.menu_manager.tutorials.return_to_port
